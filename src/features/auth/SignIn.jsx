            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center gap-2 cursor-pointer">
                <input
                  ...
                  className="hidden"
                />
                <div className={`w-5 h-5 rounded-full border-2 flex items-center justify-center transition-colors ${form.remember ? "border-primary bg-primary" : "border-gray-300"}`}>
                  {form.remember && <div className="w-2 h-2 rounded-full bg-white" />}
                </div>
